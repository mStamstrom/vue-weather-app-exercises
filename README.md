...
In this exercise, feel free to play around with Vue and get creative. Thereby also the instructions will no be as clear. In this step you have a new page that you can what you feel like with. What I did in step-6 was to create a forecast view, if you want to follow my example of step-6, what I did was:

* Get the forecast from the API

* Display the list of forecasts at the bottom of the page

* Display the current temperatur in the middle of the page

* Then fetch some nice weather images of pexlr.com

* Then map the current weather to an background image from the pixelr images.

* Change the forecast list so they are buttons, when clicking a button, the background image and the temperatur displayed in the middle of the page will change to what the user clicked.

My view ended up like this:
![step-6](./examples/step-6.PNG)

This code for step 6 is also available under branch names step-6

## God job!

Thats it for these exercises, hope you found them useful and that you learned something new about Vue. Feel free to keep developing the weather app. There are a lot more thing that can be done
